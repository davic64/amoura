  ...
  return (
    <main className="min-h-screen bg-[#F8F5F6] pb-32">
      ...
      <div className="px-6 flex flex-col gap-8">
        {/* User Card */}
        <section className="bg-white rounded-[40px] p-8 shadow-xl shadow-black/2 ring-1 ring-black/3 flex flex-col items-center text-center">
        ...
        {/* Version Info */}
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-300 text-center mt-4">
